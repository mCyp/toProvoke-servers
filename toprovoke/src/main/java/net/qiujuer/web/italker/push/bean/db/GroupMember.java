...
public class GroupMember {
    ...
    public static final int PERMISSION_TYPE_ADMIN = 2; //管理员
    public static final int PERMISSION_TYPE_ADMIN_SU = 1; //创建者

    public static final int NOTIFY_LEVEL_INVALID = -1; //默认不接受信息
